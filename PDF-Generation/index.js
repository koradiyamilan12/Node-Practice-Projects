...
app.get("/invoice", async (req, res) => {
  try {
    ...
    const pdfBuffer = await page.pdf({
      format: "A4",
      margin: { top: "50px", right: "20px", bottom: "20px", left: "20px" },
      printBackground: true,
      displayHeaderFooter: true,
      headerTemplate: "<div style='text-align: center; font-size: 30px; border-bottom: 1px solid #000; padding-bottom:10px; width:100%'>My Company</div>",
